...
//   // ✅ Static Data Find
//   const data = blogsData.find((item) => item.slug === blogId);

//   // ✅ Related Blogs
//   const filterdBlog = blogsData.filter((blog) => blog.slug !== blogId);
...
//                   __html:
//                     data?.content ||
//                     "<h1>No Blog Content Found</h1><p>This article is coming soon.</p>",
//                 }}
