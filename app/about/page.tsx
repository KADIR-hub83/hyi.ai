...
export default async function AboutUsPage() {
  // Static data instead of backend API
  const data: AboutUsData = {
    data: {
      ...
      countryData: [
        { country: "India", count: 4500 },
        { country: "USA", count: 2200 },
        { country: "UK", count: 1400 },
        { country: "Singapore", count: 900 },
        { country: "Canada", count: 700 },
      ],
      monthData: [
        { month: "01", monthName: "Jan", count: 1200 },
        { month: "02", monthName: "Feb", count: 1800 },
        { month: "03", monthName: "Mar", count: 2600 },
        { month: "04", monthName: "Apr", count: 3400 },
        { month: "05", monthName: "May", count: 4200 },
        { month: "06", monthName: "Jun", count: 5100 },
      ],
    },
    totalCount: 12500,
  };
