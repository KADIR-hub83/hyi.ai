        ...
        <div className="w-full max-w-[1280px] flex flex-col px-4">
          <div className="relative flex flex-col items-center justify-center pt-12 pb-6 gap-10 md:pt-16 md:pb-8 lg:overflow-visible">
            <div className="w-full flex flex-col text-center gap-2.5 z-10 md:w-2/3">
              <h2 className="text-2xl font-bold">Automation for Complex Workflows</h2>
            ...
            <div className="flex flex-col z-10 gap-4 md:gap-5">
              <div className="flex flex-col gap-4 md:flex-row md:gap-5">
                <div className="w-full flex flex-col items-center glass-gradient rounded-2xl px-4 py-5 gap-5 md:w-1/2 border border-white/30 lg:flex-row">
                ...
                <div className="w-full flex flex-col glass-gradient rounded-2xl px-4 py-5 gap-5 md:w-1/2 border border-white/30 ">
                  <div>
                    <Image
                      src={automation_02}
                      alt="Statistics Image"
                  ...
                  <div className="w-full flex flex-col gap-0.5 md:w-4/5">
                    <h3 className="text-lg font-semibold">Stay on Schedule</h3>
                    <p className="font-light text-gray-300 text-sm">
              ...
              <div className="w-full flex flex-col items-center glass-gradient rounded-2xl px-4 py-5 gap-5 border border-white/30">
