...
export default function KPI() {
 ...
 <CustomWrapper padding="px-4 ">
      ...
      <div className="relative flex flex-col items-center justify-center py-6 gap-10 z-10 md:py-10 lg:py-14 rounded-3xl border border-white/20 overflow-hidden ">
        ...
        <div className="relative w-full flex flex-col items-center gap-10 ">
          ...
          <div className="w-full flex flex-col text-center gap-2.5 md:w-1/2 px-3">
            <h2 className="text-2xl  font-semibold text-white">
              Smarter Performance Management with AI
            </h2>
        ...
        <div className="w-full max-w-[1280px] flex flex-col px-4">
          <div className="relative flex flex-col items-center justify-center pt-12 pb-6 gap-10 md:pt-16 md:pb-20  lg:overflow-visible">
            <div className="w-full flex flex-col text-center gap-2.5 z-10 md:w-1/2 ">
              <h2 className="text-2xl font-bold">Align Teams with Strategic Goals</h2>
              <p className="text-[16px] text-gray-300">
            ...
            <div className="flex flex-col z-10 gap-4 md:flex-row md:gap-5">
              <div className="w-full flex flex-col glass-gradient rounded-2xl px-4 pt-5 gap-5 md:w-1/2 border border-white/30 ">
              ...
              <div className="w-full flex flex-col glass-gradient rounded-2xl px-4 pt-5 gap-5 md:w-1/2 border border-white/30 ">
                <div className="w-full flex flex-col px-5 gap-0.5 md:w-4/5 z-50">
