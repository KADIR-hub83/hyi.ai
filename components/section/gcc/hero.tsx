                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 justify-between items-center text-center md:text-left">
                        ...
                        <div className="flex-1 md:max-w-[80%] space-y-2 md:space-y-4">
                            <div className="space-y-0 md:space-y-2">
                                {splitTitle ? (
                                    <>
                                        <h1 className="text-3xl font-bold gradient-text bg-clip-text leading-tight mb-0">
                                            {data.title}
                                        </h1>

                                        {data.titleHighlighted && (
                                            <h1 className="text-3xl z-60 bg-gradient-to-t from-brand-600 to-brand-500 bg-clip-text text-transparent normal-case leading-tight">
