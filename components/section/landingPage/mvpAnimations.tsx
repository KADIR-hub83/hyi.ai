...
import { mvpData } from "@/app/data/landingPage";
import CustomGradientHoverWrapper from "@/components/shared/CoustomWrapper";
  ...
  return (
    <div className="w-full flex flex-col items-center gap-8  ">
      <div className="w-full flex flex-col text-center gap-1.5 md:w-2/3">
        <h2 className="text-2xl font-bold text-dark_mode-100 ont-bold tracking-tighter mb-2 bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-400">{mvpData.heading}</h2>
        <p className="text-dark_mode-300 text-gray-400 text-sm">{mvpData.paragraph}</p>
      </div>
